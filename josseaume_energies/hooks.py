...
app_name = "josseaume_energie"
app_title = "Josseaume Energie"
...
app_include_js = ["/assets/josseaume_energie/js/event_calendar.js"]
app_include_css = ["/assets/josseaume_energie/css/event_calendar.css"]
